...
<form action="{{ route('reset.password.post') }}" method="POST" class="registerloginForm">
 ...
 <div class="span-size  col-md-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <label for="password-confirm" class="col-form-label error m-0 text-danger text-md-right bold"></label>
