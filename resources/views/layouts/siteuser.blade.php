  ...
  <span>
    ...
    <div id="mobile-pageaccount" class="mobile-boxpage d-flex hidden-md-up" data-titlebox-parent="Account">
      ...
      <div id="stickymenu_bottom_mobile" class="d-flex align-items-center justify-content-center hidden-md-up text-center">
        ...
        <script type="text/javascript" src="{{ asset('assets/front/java-script/jquery.min.js') }}" ></script>


        <script type="text/javascript" src="{{ asset('assets/front/java-script/jquery.validate.js') }}" ></script>
        <script type="text/javascript" src="{{ asset('assets/front/java-script/validate.js') }}" ></script>
