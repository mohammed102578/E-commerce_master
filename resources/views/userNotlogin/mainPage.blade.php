...
<div class="container">
    ...
    <a rel="nofollow"    href="{{ route('mainpagenotlogin.product_discount') }}" class="latief " style="display: inline-block;">
    المنتجات المخفضة
    </a>
    <a rel="nofollow"  href="{{ route('mainpagenotlogin.product_new') }}" class="latief " style="display: inline-block;">
   المنتجات الجديدة
    </a>
    <a rel="nofollow"  href="{{ route('mainpagenotlogin.product_low') }}" class="latief " style="display: inline-block;">
    السعر: منخفض إلى مرتفع
    </a>
    <a rel="nofollow"  href="{{ route('mainpagenotlogin.product_high') }}" class="latief " style="display: inline-block;">
...
?>
    ...
    <a href="{{ route('mainpagenotlogin.product_page',$product->id) }}" class="thumbnail product-thumbnail two-image">
    ...
    <div class="product-group-price">
      ...
      <span itemprop="vendor" class="vendor pull-left">{{ $product->vendor->name }}</span>
