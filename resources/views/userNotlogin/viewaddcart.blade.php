...
<table class="table table-striped table-bordered text-center latief"dir="rtl">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a class="remove-from-cart" rel="nofollow" href="{{ route('mainpagenotlogin.delete',$carts->id )}}" >
...
?>
  ...
  <a class="label btn btn-primary" href="{{ route('user.home') }}">
    الاستمرار في التسوق
  </a>
...
<span class="value latief ">(شامل للضريبة)</span>
</div>
